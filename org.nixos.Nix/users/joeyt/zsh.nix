...
# Configuration settings for Zsh
{
  ...
  siteFunctions = {
    _python-workon-cwd = builtins.readFile ../../../net.sourceforge.Zsh/zfunc/_python-workon-cwd;
    j = builtins.readFile ../../../net.sourceforge.Zsh/zfunc/j;
    lsGF = if pkgs.stdenv.isLinux then "command ls --color --classify" else "command ls -GF";
    mkcd = builtins.readFile ../../../net.sourceforge.Zsh/zfunc/mkcd;
    print_array = builtins.readFile ../../../net.sourceforge.Zsh/zfunc/print_array;
    rmmetadata = builtins.readFile ../../../net.sourceforge.Zsh/zfunc/rmmetadata;
    d = builtins.readFile ../../../net.sourceforge.Zsh/zfunc/d;
    cpv = builtins.readFile ../../../net.sourceforge.Zsh/zfunc/cpv;
